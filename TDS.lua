    ...
    while _G.AutoFarm do wait(0.1)
		Dropdown:OnChanged(function(Value)
			if Value == "Crossroads" then
				...
				while Towers:GetChildren()[1].Upgrades["2"].EarPiece.Transparency == 1 do wait(0.1)
				...
				while Towers:GetChildren()[2].Upgrades["2"].Torso1.Transparency == 1 do wait(0.1)
					upgradeTower(Towers:GetChildren()[2])
				end
				while #Towers:GetChildren() ~= 3 do wait(0.1)
				...
				while Towers:GetChildren()[3].Upgrades["2"].Torso1.Transparency == 1 do wait(0.1)
					upgradeTower(Towers:GetChildren()[3])
				end
				while #Towers:GetChildren() ~= 4 do wait(0.1)
				...
				while Towers:GetChildren()[4].Upgrades["2"].Torso1.Transparency == 1 do wait(0.1)
					upgradeTower(Towers:GetChildren()[4])
				end
				while #Towers:GetChildren() ~= 5 do wait(0.1)
				...
				while Towers:GetChildren()[5].Upgrades["2"].EarPiece.Transparency == 1 do wait(0.1)
					upgradeTower(Towers:GetChildren()[5])
				end
				while #Towers:GetChildren() ~= 6 do wait(0.1)
				...
				while Towers:GetChildren()[6].Upgrades["2"].EarPiece.Transparency == 1 do wait(0.1)
					upgradeTower(Towers:GetChildren()[6])
				end
				while #Towers:GetChildren() ~= 7 do wait(0.1)
				...
				while Towers:GetChildren()[7].Upgrades["2"].EarPiece.Transparency == 1 do wait(0.1)
					upgradeTower(Towers:GetChildren()[7])
				end
				while #Towers:GetChildren() ~= 8 do wait(0.1)
				...
				while Towers:GetChildren()[8].Upgrades["2"].EarPiece.Transparency == 1 do wait(0.1)
					upgradeTower(Towers:GetChildren()[8])
				end
				while Towers:GetChildren()[1].Upgrades["3"].MoneyCase.Transparency == 1 do wait(0.1)
					upgradeTower(Towers:GetChildren()[1])
				end
